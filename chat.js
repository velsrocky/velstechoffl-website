  ...
  function ensureContainer() {
    ...
    root.innerHTML = `
      <button id="vt-chat-bubble" class="vt-bubble" aria-label="${_t("chat_open")}" aria-expanded="false">
        <img src="/robot-bulb.png?v=1" alt="" width="34" height="34" class="vt-bubble-img" aria-hidden="true" loading="lazy" onerror="this.style.display='none'; this.nextElementSibling.style.display='block'"/>
